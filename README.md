...
**It is recommended to grab the latest release from the releases page (Rather than `curl`ing), because those will be the most up-to-date. *Please* do not download the zip from the "code" tab. Please.**
### MacOS
